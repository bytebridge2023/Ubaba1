(function (window, document, $, undefined) {
  ...
  var FancyBox = function (content, opts, index) {
    var self = this;
    self.opts = $.extend(!0, { index: index }, $.fancybox.defaults, opts || {});
    ...
    jumpTo: function (pos, duration, slide) {
      ...
      if (current.isMoved) {
        ...
        $.each(self.slides, function (index, slide) {
          ...
          $.fancybox.animate(
            slide.$slide,
            { top: 0, left: pos * canvasWidth + pos * slide.opts.gutter },
            duration,
            function () {
              slide.$slide
                .removeAttr("style")
          ...
          if ($body && $body.length) {
            if (frameWidth === undefined) {
              ...
              frameWidth = Math.ceil(
                $body.outerWidth(!0) + ($wrap.width() - scrollWidth)
              );
      ...
      if (self.opts.axis === "x") {
        self.$list.width(
          parseInt(self.$grid.css("padding-right")) +
            instance.group.length * self.$list.children().eq(0).outerWidth(!0) +
            "px"
        );
      }
    },
