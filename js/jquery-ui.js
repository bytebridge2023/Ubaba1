...
(function (factory) {
  ...
  $.Widget.prototype = {
    ...
    _trigger: function (type, event, data) {
      ...
      return !(
        ($.isFunction(callback) &&
          callback.apply(this.element[0], [event].concat(data)) === !1) ||
  ...
  $.each({ show: "fadeIn", hide: "fadeOut" }, function (method, defaultEffect) {
    $.Widget.prototype["_" + method] = function (element, options, callback) {
      ...
      var effectName = !options
        ? method
        : options === !0 || typeof options === "number"
        ? defaultEffect
  ...
  var widgetsAccordion = $.widget("ui.accordion", {
    ...
    _create: function () {
      ...
      if (
        !options.collapsible &&
        (options.active === !1 || options.active == null)
      ) {
        options.active = 0;
      }
      this._processPanels();
    ...
    refresh: function () {
      ...
      this._processPanels();
      if (
        (options.active === !1 && options.collapsible === !0) ||
        !this.headers.length
      ) {
        options.active = !1;
        this.active = $();
    ...
    _create: function () {
      ...
      this._on(this.menu.element, {
        ...
        menufocus: function (event, ui) {
          ...
          if (!1 !== this._trigger("focus", event, { item: item })) {
        ...
        menuselect: function (event, ui) {
          ...
          if (!1 !== this._trigger("select", event, { item: item })) {
            this._value(item.value);
          }
  ...
  if ($.uiBackCompat !== !1) {
    ...
    $.fn.button = (function (orig) {
      return function () {
        ...
        if (arguments.length === 0) {
          return this.checkboxradio({ icon: !1 });
        }
 ...
 */
  ...
  var widgetsMouse = $.widget("ui.mouse", {
    ...
    _mouseMove: function (event) {
      ...
      if (this._mouseDistanceMet(event) && this._mouseDelayMet(event)) {
        this._mouseStarted =
          this._mouseStart(this._mouseDownEvent, event) !== !1;
  ...
  $.widget("ui.spinner", {
    ...
    _spin: function (step, event) {
      ...
      if (
        !this.spinning ||
        this._trigger("spin", event, { value: value }) !== !1
      ) {
        this._value(value);
        this.counter++;
      }
